...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ChopeControl" },
      { name: "description", content: "Sistema de gestão para distribuidora de chope." },
      { property: "og:title", content: "ChopeControl" },
      { property: "og:description", content: "Sistema de gestão para distribuidora de chope." },
