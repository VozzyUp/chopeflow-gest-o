...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "V-Chopp" },
      { name: "description", content: "Sistema de gestão para distribuidora de chopp." },
      { property: "og:title", content: "V-Chopp" },
      { property: "og:description", content: "Sistema de gestão para distribuidora de chopp." },
